...
# # Boston Red Sox Standings, 1901-present
# This script downloads the team's current standings table from [Baseball Reference](https://www.baseball-reference.com/teams/BOS/2024-schedule-scores.shtml) and combines it with historic records for later analysis and visualization.
...
csv_file = f"{output_dir}/redsox_standings_1958_present.csv"
csv_file_slim = f"{output_dir}/redsox_standings_1958_present_optimized.csv"
json_file = f"{output_dir}/redsox_standings_1958_present.json"
json_file_slim = f"{output_dir}/redsox_standings_1958_present_optimized.json"
# historic_file = "https://redsox-data/dodgers/data/standings/archive/dodgers_standings_1958_2024.parquet"
# Pointing to local historic file which should be generated by another script
historic_file = f"{output_dir}/archive/redsox_standings_1958_2024.parquet"
parquet_file = f"{output_dir}/redsox_standings_1958_present.parquet"
s3_bucket = "redsox-data"
s3_key_csv = "redsox/data/standings/redsox_standings_1958_present.csv"
s3_key_json = "redsox/data/standings/redsox_standings_1958_present.json"
s3_key_slim_csv = "redsox/data/standings/redsox_standings_1958_present_optimized.csv"
s3_key_slim_json = "redsox/data/standings/redsox_standings_1958_present_optimized.json"
s3_key_parquet = "redsox/data/standings/redsox_standings_1958_present.parquet"
